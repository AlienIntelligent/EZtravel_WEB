...
const inputClass =
  "h-11 w-full rounded-md border border-slate-300 bg-white px-3 text-sm text-slate-900 outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20";
        ...
        <section className="overflow-hidden rounded-md border border-slate-200 bg-white shadow-sm">
          ...
          <div className="space-y-6 p-5 sm:p-8">
            <div>
              ...
              {preview.summary ? (
                <div className="mt-3 flex gap-3 rounded-md border border-sky-200 bg-sky-50 p-4 text-sm leading-6 text-sky-950">
                  <Bot className="mt-0.5 h-5 w-5 shrink-0 text-sky-700" aria-hidden="true" />
                  <p>{preview.summary}</p>
                </div>
              ) : null}
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {[
                ...
                <div key={label} className="flex items-center gap-3 rounded-md border border-slate-200 p-4">
  ...
  return (
    <main className="mx-auto w-full max-w-3xl p-4 sm:p-6 lg:p-8">
      <header className="mb-6">
        ...
        <h1 className="mt-4 text-2xl font-bold text-slate-950 sm:text-3xl">Tạo lịch trình bằng AI</h1>
        <p className="mt-2 text-sm leading-6 text-slate-600">
          Nhập nhu cầu thực tế để tạo một lịch trình có thể lưu trực tiếp vào chuyến đi.
        </p>
      </header>

      <form onSubmit={handleSubmit} className="space-y-5 rounded-md border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
        {errorMessage ? (
          <div className="border-l-4 border-rose-600 bg-rose-50 p-4 text-sm text-rose-800" role="alert">
            {errorMessage}
          </div>
        ...
        <div className="space-y-1.5">
          <label htmlFor="ai-destination" className="text-sm font-semibold text-slate-800">Điểm đến</label>
          <input
            id="ai-destination"
            type="text"
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-1.5">
            <label htmlFor="ai-start-date" className="text-sm font-semibold text-slate-800">Ngày đi</label>
          ...
          <div className="space-y-1.5">
            <label htmlFor="ai-end-date" className="text-sm font-semibold text-slate-800">Ngày về</label>
        ...
        <div className="space-y-1.5">
          <label htmlFor="ai-budget" className="text-sm font-semibold text-slate-800">Ngân sách</label>
        ...
        <fieldset className="space-y-2">
          <legend className="text-sm font-semibold text-slate-800">Sở thích</legend>
        ...
        <div className="space-y-1.5">
          <label htmlFor="ai-notes" className="text-sm font-semibold text-slate-800">Ghi chú thêm</label>
          <textarea
            id="ai-notes"

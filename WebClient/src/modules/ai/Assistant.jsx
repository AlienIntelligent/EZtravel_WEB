  ...
  return (
    <main className="mx-auto flex h-[calc(100vh-5rem)] w-full max-w-5xl flex-col p-3 sm:p-6">
      <section className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-md border border-slate-200 bg-white shadow-sm">
        ...
        <div className="min-h-0 flex-1 space-y-4 overflow-y-auto bg-slate-50 p-4 sm:p-5" aria-live="polite">
          {chatHistory.length === 0 ? (
            <div className="flex h-full min-h-52 flex-col items-center justify-center text-center">
              ...
              <p className="mt-3 text-sm font-medium text-slate-700">Bạn muốn lên kế hoạch cho chuyến đi nào?</p>
            </div>
          ) : null}
        ...
        <footer className="border-t border-slate-200 bg-white p-3 sm:p-4">
          <form onSubmit={handleSubmit} className="flex gap-2">
            ...
            <input
              ...
              type="text"
              className="h-11 min-w-0 flex-1 rounded-md border border-slate-300 bg-white px-3 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"

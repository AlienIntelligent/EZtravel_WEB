  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-16">
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white border-b pb-2">
          1. Typography Scale
        </h2>
        <div className="space-y-6 bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800">
          <div>
            <span className="text-xs text-slate-400 block mb-1">Display (Poppins Bold 48px / 3rem)</span>
            <span className="text-5xl font-serif font-bold tracking-tight">Display Headline</span>
          </div>
          <div>
            <span className="text-xs text-slate-400 block mb-1">H1 (Poppins Bold 36px / 2.25rem)</span>
            <h1 className="text-4xl font-serif font-bold">Heading 1</h1>
          </div>
          <div>
            <span className="text-xs text-slate-400 block mb-1">H2 (Poppins SemiBold 30px / 1.875rem)</span>
            <h2 className="text-3xl font-serif font-semibold">Heading 2</h2>
          </div>
          <div>
            <span className="text-xs text-slate-400 block mb-1">H3 (Poppins SemiBold 24px / 1.5rem)</span>
            <h3 className="text-2xl font-serif font-semibold">Heading 3</h3>
          </div>
          <div>
            <span className="text-xs text-slate-400 block mb-1">H4 (Poppins SemiBold 20px / 1.25rem)</span>
            <h4 className="text-xl font-serif font-semibold">Heading 4</h4>
          </div>
          <div>
            <span className="text-xs text-slate-400 block mb-1">Body Large (Inter Regular 18px / 1.125rem)</span>
            <p className="text-lg">This is large body copy used for lead paragraphs and instructions.</p>
          </div>
          <div>
            <span className="text-xs text-slate-400 block mb-1">Body (Inter Regular 16px / 1.0rem)</span>
            <p className="text-base">This is standard body copy used for descriptions, forms, and general content reading.</p>
          </div>
          <div>
            <span className="text-xs text-slate-400 block mb-1">Caption (Inter Medium 12px / 0.75rem)</span>
            <p className="text-xs font-medium text-slate-500">This is caption text used for dates, metadata, and helper text labels.</p>
          </div>
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <h3 className="text-lg font-semibold text-slate-900 dark:text-white mt-6 mb-2">Map Tokens</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <section className="space-y-6">
        ...
        <div className="flex flex-wrap gap-4 p-6 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800">
        ...
        <div className="space-y-4 bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Text Input</label>
              <Input type="text" placeholder="Nhập văn bản..." />
            </div>
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Select Choice</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Textarea Comments</label>
        ...
        <div className="space-y-4 bg-white dark:bg-slate-900 p-6 rounded-xl border border-slate-200 dark:border-slate-800">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <span className="text-sm font-medium block text-slate-500">Tabs Control</span>
            ...
            <div className="space-y-4">
              <span className="text-sm font-medium block text-slate-500">Avatar & Skeleton Loading</span>
              <div className="flex items-center gap-4">
                <Avatar>
                  <AvatarFallback className="bg-slate-200 text-slate-800">AM</AvatarFallback>
                </Avatar>

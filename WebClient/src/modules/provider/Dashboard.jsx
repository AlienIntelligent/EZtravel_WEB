...
export default function ProviderDashboard() {
 ...
 Chào mừng trở lại, <span className="font-semibold text-foreground ">{user?.fullName || user?.email}</span>. Quản lý trạng thái gói cước và hiệu suất quảng bá của bạn.
 </p>
 </div>
 {badgeType &&
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
 {/* Package Name & Status */}
 <div className="bg-background p-5 rounded-2xl border border-border shadow-sm flex flex-col justify-between">
 ...
 <div className="bg-background p-6 rounded-2xl border border-border shadow-sm flex flex-col justify-between h-48">
 <div className="flex justify-between items-start">
 <div>
 <span className="text-xs font-semibold text-muted-foreground block uppercase tracking-wider">
 Lượt xem dịch vụ
 </span>
 <span className="text-lg font-bold text-muted-foreground mt-2 block italic">
 Chưa hỗ trợ
 </span>
 </div>
 ...
 <div className="mt-4 pt-3 border-t border-border text-xs text-muted-foreground">
 <span className="bg-muted px-2 py-1 rounded">Sắp ra mắt ở Sprint sau</span>
 </div>
 </div>

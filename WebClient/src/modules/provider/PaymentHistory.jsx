...
export default function ProviderPaymentHistory() {
 ...
 {payments.map((item) =>
 <tr key={item.maThanhToanNcc} className="hover:bg-background/50 dark:hover:bg-slate-950/20">
 ...
 <div>
 <span className="text-muted-foreground block text-[10px]">Ngày thanh toán</span>
 ...
 <span className="text-muted-foreground block text-[10px]">Số tiền</span>

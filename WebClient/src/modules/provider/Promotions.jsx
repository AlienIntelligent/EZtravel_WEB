...
export default function ProviderPromotions() {
 ...
 <div className="bg-background rounded-2xl border border-border shadow-sm p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
 <div>
 ...
 <span className="text-xs font-medium text-muted-foreground">Huy hiệu đối tác:</span>
 {badgeType ?

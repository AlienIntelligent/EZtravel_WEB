...
export default function ProviderPackages() {
 ...
 <div className="h-12 w-64 bg-slate-200 rounded-md" />
 ...
 {/* Page Title & Intro */}
 <div className="bg-background p-6 rounded-2xl border border-border shadow-sm text-center max-w-3xl mx-auto">
 ...
 <div
 key={pkg.maGoiNcc}
 className={`flex flex-col bg-background rounded-2xl border transition-all duration-300 relative h-full ${
 isCurrent ?
 ...
 <p className="text-xs text-muted-foreground mt-3 line-clamp-2 h-8">
 {pkg.moTa || "Gói dịch vụ dành cho nhà cung cấp ezTravel."}
 </p>
 </div>

 {/* Package Pricing */}
 <div className="p-6 py-4 bg-background/50 text-center">
 <div className="space-y-1">
 <div className="text-2xl font-extrabold text-foreground ">
 {pkg.giaThang === 0 ? "Miễn phí" : `${pkg.giaThang.toLocaleString()}đ`}
 {pkg.giaThang > 0 && <span className="text-xs font-normal text-muted-foreground">/tháng</span>}
 </div>
 {pkg.giaNam > 0 &&
 ...
 <DialogHeader>
 <DialogTitle className="text-lg font-sans font-bold text-foreground flex items-center gap-2">
 ...
 "border-border hover:bg-background dark:hover:bg-slate-800"}`
 }>
 ...
 <div className="bg-background dark:bg-slate-950 p-4 rounded-xl border border-border dark:border-slate-850 space-y-2 text-xs">

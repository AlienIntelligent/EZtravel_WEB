  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto py-4">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
        <div className="bg-gradient-to-r from-teal-500/10 to-sky-500/10 p-6 border-b border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <span className="text-xs font-semibold text-teal-600 dark:text-teal-400 uppercase tracking-wider block">
              Gói dịch vụ
            </span>
            <h4 className="text-xl font-bold text-slate-900 dark:text-slate-50 mt-1">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-slate-400 text-xs block">Ngày bắt đầu</span>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <Calendar className="w-4 h-4 text-slate-400" />
              <div>
                <span className="text-slate-400 text-xs block">Ngày kết thúc</span>
                <span className="font-semibold text-slate-800 dark:text-slate-200">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          "border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/20 opacity-60"}`
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <Search className={`w-5 h-5 ${currentPackage.uuTienTimKiem ? "text-teal-600 dark:text-teal-400" : "text-slate-400"}`} />
                {currentPackage.uuTienTimKiem ?
            ...
            <div className="text-[10px] font-semibold mt-3 text-slate-400">
          ...
          "border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/20 opacity-60"}`
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <Home className={`w-5 h-5 ${currentPackage.uuTienTrangChu ? "text-teal-600 dark:text-teal-400" : "text-slate-400"}`} />
                {currentPackage.uuTienTrangChu ?
                <CheckCircle2 className="w-4 h-4 text-emerald-500" /> :
          ...
          "border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/20 opacity-60"}`
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <Compass className={`w-5 h-5 ${currentPackage.heSoUuTien > 1.0 ? "text-teal-600 dark:text-teal-400" : "text-slate-400"}`} />
                {currentPackage.heSoUuTien > 1.0 ?
                <CheckCircle2 className="w-4 h-4 text-emerald-500" /> :

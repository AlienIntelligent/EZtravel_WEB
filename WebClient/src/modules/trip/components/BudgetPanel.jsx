...
function BudgetPanel() {
 ...
 <h2 className="font-bold text-foreground">Chi phí chuyến đi</h2>
 </div>
 </header>

 <div className="grid grid-cols-3 divide-x divide-slate-200 border-b border-border">
 {[
 ...
 {nodes.length === 0 ? (
 <div className="px-5 py-10 text-center text-sm leading-6 text-muted-foreground">
 ...
 <span className="shrink-0 font-semibold text-foreground">{formatCurrency(cost)}</span>
 </div>
 );
 })}
 </div>
 ...
 <div className="border-t border-slate-150 bg-background/50 p-3.5">
 {advice ? (
 ...
 <span className="text-sm font-semibold text-muted-foreground">Tổng dự kiến</span>

...
function SortableItem({ item, title }) {
 ...
 <div className="card-body p-3 d-flex align-items-center bg-background" style={{ borderRadius: '12px' }}>
...
function DayCard({ dayId, title }) {
 ...
 <div className="card-header bg-background border-0 pt-4 pb-0 d-flex justify-content-between align-items-center">

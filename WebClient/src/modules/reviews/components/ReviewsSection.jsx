...
export function ReviewsSection({ targetId, type = "place" }) {
 ...
 {/* Write Review Form */}
 <form onSubmit={handleSubmit} className="mb-8 p-4 bg-background rounded-lg">
 ...
 {isLoading ? (
 <div className="text-center text-muted-foreground py-4">Đang tải đánh giá...</div>
 ) : reviews.length === 0 ? (
 <div className="text-center text-muted-foreground py-4">Chưa có đánh giá nào. Hãy là người đầu tiên!</div>
 ) : (
 reviews.map((review) => (

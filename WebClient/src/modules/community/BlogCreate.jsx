...
export default function BlogCreate() {
 ...
 <div>
 <h1 className="text-3xl font-bold text-foreground">Viết bài blog</h1>
 <p className="mt-2 text-sm text-muted-foreground">
 Chia sẻ lịch trình, kinh nghiệm hoặc câu chuyện du lịch với cộng đồng.
 </p>
 </div>
 </div>
 ...
 placeholder="VD: 3 ngày ăn chơi Đà Nẵng tự túc"
 value={form.title}
 ...
 placeholder="Một đoạn ngắn để người đọc nắm nhanh hành trình của bạn..."
 value={form.summary}
 ...
 placeholder="Kể lại lịch trình, chi phí, món ngon, lưu ý di chuyển..."
 value={form.content}
 ...
 {previewImage ? (
 <img src={previewImage} alt="Blog preview" className="h-44 w-full object-cover" onError={(e) => { e.target.onerror = null; e.target.src = "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?q=80&w=600&auto=format&fit=crop"; }} />
 ) : (
 ...
 <div className="rounded-md border bg-background p-4 shadow-sm">
 <h2 className="text-sm font-bold text-foreground">Liên kết địa điểm</h2>
 <p className="mt-1 text-xs leading-5 text-muted-foreground">
 Nếu đã biết mã địa điểm trong hệ thống, nhập vào để bài viết hiện theo địa điểm đó.
 </p>
 <input
 className="mt-3 h-10 w-full rounded-md border bg-background px-3 text-sm outline-none transition focus:border-primary"

...
export default function OtpVerification() {
 ...
 onPaste={handlePaste}
 className="h-12 w-12 rounded-xl border-2 border-input bg-background text-center text-lg font-bold outline-none transition-all focus:border-primary focus:ring-2 focus:ring-primary/20 sm:h-14 sm:w-14 sm:text-2xl "
 autoFocus={index === 0}
 />
 ))}
 </div>

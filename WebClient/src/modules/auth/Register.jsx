...
export default function Register() {
 ...
 {step < 3 ? (
 <Button type="button" className="h-12 flex-1 font-semibold" onClick={handleNext}>
 Tiếp tục
 <ChevronRight className="w-4 h-4 ml-2" />
 </Button>
 ) : (
 <Button type="submit" className="h-12 flex-1 font-semibold bg-cta hover:bg-cta/90 text-white shadow-md shadow-cta/20 border-0" disabled={isRegistering}>

...
export function Sidebar({ isMobileOpen, setIsMobileOpen, previewMode = false }) {
 ...
 <aside 
 className="fixed inset-y-0 z-[10000] w-[272px] border-r border-border bg-background shadow-xl transition-all duration-300 ease-in-out md:hidden"
 ...
 <>
 {/* Desktop Sidebar */}
 <aside className="hidden h-full w-[248px] flex-shrink-0 flex-col border-r border-border bg-background md:flex z-20">
 {sidebarContent}
 </aside>

...
function BaseDashboardLayout({
 ...
 {/* Navbar */}
 <header className="bg-background border-bottom shadow-sm d-flex align-items-center justify-content-between px-4" style={{ height: '60px', zIndex: 10 }}>
 ...
 {isUserMenuOpen &&
 <div className="position-absolute bg-background border shadow-sm rounded p-2 mt-1 end-0" style={{ width: '200px' }}>

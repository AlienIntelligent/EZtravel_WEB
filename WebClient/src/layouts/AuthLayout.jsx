...
export default function AuthLayout() {
 ...
 <Link to="/" className="font-sans text-3xl font-bold tracking-tight text-white flex items-center gap-2">
 ...
 <span className="text-primary font-sans italic font-normal">theo cách của bạn</span>
 </h1>
 ...
 <div className="text-xs text-muted-foreground relative z-10 flex gap-4 items-center">
 ...
 <Link to="/" className="font-sans text-2xl font-bold text-primary flex items-center gap-2 lg:hidden">

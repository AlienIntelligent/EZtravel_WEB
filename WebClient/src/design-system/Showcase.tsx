...
export default function Showcase() {
 ...
 <div>
 <h1 className="text-4xl font-sans font-bold text-primary">EZTravel Design System</h1>
 ...
 <h2 className="text-2xl font-sans font-semibold border-b border-border pb-2">Typography (Playfair Display & Be Vietnam Pro)</h2>
 <div className="space-y-4">
 <h1 className="text-5xl font-sans">Heading 1 - Playfair Display</h1>
 <h2 className="text-4xl font-sans">Heading 2 - Playfair Display</h2>
 <h3 className="text-3xl font-sans">Heading 3 - Playfair Display</h3>
 <h4 className="text-2xl font-sans">Heading 4 - Playfair Display</h4>
 <h5 className="text-xl font-sans">Heading 5 - Playfair Display</h5>
 ...
 <section className="space-y-6">
 <h2 className="text-2xl font-sans font-semibold border-b border-border pb-2">Buttons</h2>
 ...
 <section className="space-y-6">
 <h2 className="text-2xl font-sans font-semibold border-b border-border pb-2">Inputs & Forms</h2>
 ...
 <section className="space-y-6">
 <h2 className="text-2xl font-sans font-semibold border-b border-border pb-2">Cards & Badges</h2>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <Card>
 <CardHeader>
 <div className="flex justify-between items-start">
 <div>
 <CardTitle className="font-sans">Trip to Da Nang</CardTitle>
 ...
 <section className="space-y-6">
 <h2 className="text-2xl font-sans font-semibold border-b border-border pb-2">Tabs & Dialogs</h2>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 ...
 <DialogContent>
 <DialogHeader>
 <DialogTitle className="font-sans">Confirm Deletion</DialogTitle>
 <DialogDescription>
 ...
 <section className="space-y-6">
 <h2 className="text-2xl font-sans font-semibold border-b border-border pb-2">UI Workflow States</h2>
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 ...
 <CardTitle className="text-destructive font-sans">Failed to load destination</CardTitle>
 </div>
 </CardHeader>
 <CardContent>
 ...
 <CardTitle className="text-green-700 dark:text-green-400 font-sans">Payment Successful</CardTitle>
 </div>
 </CardHeader>
 <CardContent>
